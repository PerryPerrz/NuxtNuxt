...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/devalue/index.js';
import destr from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/iopeti/Desktop/NuxtNuxt/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/iopeti/Desktop/NuxtNuxt/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/iopeti/Desktop/NuxtNuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/iopeti/Desktop/NuxtNuxt/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/iopeti/Desktop/NuxtNuxt/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/iopeti/Desktop/NuxtNuxt/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/iopeti/Desktop/NuxtNuxt/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const rootDir = "/Users/iopeti/Desktop/NuxtNuxt";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _v9HdJ80kxo = (nitroApp) => {
...
const _lazy_l9yBWL = () => Promise.resolve().then(function () { return ____slug_$3; });
const _lazy_a9SYBU = () => Promise.resolve().then(function () { return _____$1; });
const _lazy_6MX7NF = () => Promise.resolve().then(function () { return ____name_$1; });
const _lazy_I1uQAG = () => Promise.resolve().then(function () { return ____slug_$1; });
const _lazy_J75Z3F = () => Promise.resolve().then(function () { return _name_$1; });
const _lazy_MsIRjs = () => Promise.resolve().then(function () { return _age_$1; });
const _lazy_XaX6bc = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_0DJU5Y = () => Promise.resolve().then(function () { return _id__get$1; });
const _lazy_JVWJGK = () => Promise.resolve().then(function () { return _id__put$1; });
const _lazy_DcQ0Ti = () => Promise.resolve().then(function () { return posts_delete$1; });
const _lazy_Pa2nCf = () => Promise.resolve().then(function () { return posts_get$1; });
const _lazy_phbCrp = () => Promise.resolve().then(function () { return posts_post$1; });
const _lazy_A9NwrD = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/**:slug', handler: _lazy_l9yBWL, lazy: true, middleware: false, method: undefined },
  { route: '/api/hello/**', handler: _lazy_a9SYBU, lazy: true, middleware: false, method: undefined },
  { route: '/api/hello/**:name', handler: _lazy_6MX7NF, lazy: true, middleware: false, method: undefined },
  { route: '/api/hello/**:slug', handler: _lazy_I1uQAG, lazy: true, middleware: false, method: undefined },
  { route: '/api/hello/:name', handler: _lazy_J75Z3F, lazy: true, middleware: false, method: undefined },
  { route: '/api/hello/:name/:age', handler: _lazy_MsIRjs, lazy: true, middleware: false, method: undefined },
  { route: '/api/post/:id', handler: _lazy_XaX6bc, lazy: true, middleware: false, method: "delete" },
  { route: '/api/post/:id', handler: _lazy_0DJU5Y, lazy: true, middleware: false, method: "get" },
  { route: '/api/post/:id', handler: _lazy_JVWJGK, lazy: true, middleware: false, method: "put" },
  { route: '/api/posts', handler: _lazy_DcQ0Ti, lazy: true, middleware: false, method: "delete" },
  { route: '/api/posts', handler: _lazy_Pa2nCf, lazy: true, middleware: false, method: "get" },
  { route: '/api/posts', handler: _lazy_phbCrp, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_A9NwrD, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_A9NwrD, lazy: true, middleware: false, method: undefined }
];
...
const ____slug_$2 = defineEventHandler(() => {
  return new Error("Not implemented");
});

const ____slug_$3 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: ____slug_$2
});

const _____ = defineEventHandler((event) => {
  return `Default foo handler CATCH-ALL`;
});
...
const ____name_ = defineEventHandler((event) => {
  const name = getRouterParam(event, "name");
  return `Hello ${name}!`;
});
...
const _id__delete = defineEventHandler(async (event) => {
  ...
  const newPosts = posts.filter((post2) => post2.id !== id);
  setPosts(newPosts);
...
const posts_delete = defineEventHandler(() => {
  return deleteAllPosts();
});

const posts_delete$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: posts_delete
});
...
const getClientManifest = () => import('file:///Users/iopeti/Desktop/NuxtNuxt/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/iopeti/Desktop/NuxtNuxt/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
